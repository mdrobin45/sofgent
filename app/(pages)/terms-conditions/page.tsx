   ...
   return (
      <>
         <BreadCrumb
            ...
            to="/terms-conditions"
         />
         <section className="w-full py-16 md:pt-[94px] items-center">
            <div className="w-full mx-auto theme-container">
               <h1 className="text-3xl font-bold pb-3">Terms and Conditions</h1>
               <p>Last updated: January 15, 2025</p>
               <p>
                  Please read these terms and conditions carefully before using
                  Our Service.
               </p>
               <h2 className="text-2xl font-bold py-3">Interpretation and Definitions</h2>
               <h3 className="text-xl font-bold py-2">Interpretation</h3>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Definitions</h3>
               ...
               <ul className="styled-list-privacy">
                  ...
                  <li>
                     <p>
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Sofgent,
                  ...
                  <li>
                     <p>
                        <strong>Website</strong> refers to Sofgent, accessible
                        from{" "}
                        <a
                           href="https://sofgent.com/"
               ...
               <h2 className="text-2xl font-bold py-3">Acknowledgment</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Links to Other Websites</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Termination</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Limitation of Liability</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Governing Law</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Severability and Waiver</h2>
               <h3 className="text-xl font-bold py-2">Severability</h3>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Waiver</h3>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Translation Interpretation</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Changes to These Terms and Conditions</h2>
               <p>
                  We reserve the right, at Our sole discretion, to modify or
                  replace these Terms at any time. If a revision is material We
                  will make reasonable efforts to provide at least 30 day&apos;
               ...
               <h2 className="text-2xl font-bold py-3">Contact Us</h2>
               <p>
               ...
               <ul className="styled-list-privacy">
                  ...
                  <li>
                     <p>
                        ...
                        <a
                           href="https://sofgent.com/contact"
                           rel="external nofollow noopener"
                           target="_blank">
                           https://sofgent.com/contact
                        </a>
                     </p>
                  </li>
               </ul>
