      ...
      <>
         ...
         <section className="w-full py-16 md:pt-[94px] items-center">
            <div className="w-full mx-auto theme-container">
               <h1 className="text-3xl font-bold pb-3">Privacy Policy</h1>
               <p className="font-bold">Last updated: January 15, 2025</p>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Collecting and Using Your Personal Data</h2>
               <h3 className="text-xl font-bold py-2">Types of Data Collected</h3>
               <h4>Personal Data</h4>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Use of Your Personal Data</h3>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Retention of Your Personal Data</h3>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Transfer of Your Personal Data</h3>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Delete Your Personal Data</h3>
               <p>
               ...
               <h3 className="text-xl font-bold py-2">Disclosure of Your Personal Data</h3>
               ...
               <h3 className="text-xl font-bold py-2">Security of Your Personal Data</h3>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Children&apos;s Privacy</h2>
               <p>
               ...
               <h2 className="text-2xl font-bold py-3">Changes to this Privacy Policy</h2>
               <p>
