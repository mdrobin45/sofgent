...
// import monitorIcon from "@assets/images/icons/computer-monitor.svg";
// import contentIcon from "@assets/images/icons/content.svg";
// import emailsendIcon from "@assets/images/icons/email-sent.svg";
                     ...
                     {/* <div
                        ...
                        <div>
                           ...
                           <p className="text-center text-paragraph">
                              ...
                              agency emerges as a beacon of innovation
                           </p>
                        </div>
                     </div>
                     <div
                        ...
                        data-aos-delay="100"
                        className="flex flex-col space-y-[30px] justify-between items-center rounded-[10px] bg-white px-8 py-10 hover:shadow-common group border border-transparent hover:border-brand common-transition">
                        <div className="w-[60px] h-[60px] flex justify-center items-center rounded-full bg-[#e7e3fa] group-hover:bg-brand common-transition text-brand group-hover:text-white">
                           <span>
                              <svg
                                 className="fill-current"
                                 width="28"
